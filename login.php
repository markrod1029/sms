...
if (isset($_POST['email'])) {
    ...
    $query = "SELECT * FROM students WHERE (email='$email' OR student_id='$email') AND password='$password'";
...
<head>
  ...
  <title>Student Login - Management System</title>
...
<div class="container">
  <section>
    <form action="" method="post">
      <h1>Login Panel</h1>
      <div>
        <input name="email" type="text" placeholder="Email Or Student ID" required>
      </div>
      <div>
